...
export class Space {
  ...
  constructor (container, opt = {}) {
    ...
    const options = opt ? merge(DefaultOptions, opt) : DefaultOptions
    ...
    this.controls.dampingFactor = options.controls.damping.factor || 0.25
  ...
  Ray (event, layer) {
    ...
    const intersects = this.raycaster.intersectObjects(layer)
